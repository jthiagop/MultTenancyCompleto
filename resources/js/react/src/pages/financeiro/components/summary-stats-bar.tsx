...
export function SummaryStatsBar({ stats, activeKey, onTabClick }: SummaryStatsBarProps) {
  return (
    ...
    // overflow-x-auto + min-w-fit no inner: em telas pequenas, mantém o
    // tamanho mínimo confortável de cada aba e expõe scroll horizontal,
    // mesmo comportamento da tabela logo abaixo (sem deformar o layout).
