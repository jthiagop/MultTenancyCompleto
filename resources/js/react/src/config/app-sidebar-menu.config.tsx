...
export const MENU_SIDEBAR = [
  ...
  { heading: 'Menu' },
  {
    ...
    icon: Wallet,
    children: [
      { title: 'Despesas',               path: '/financeiro?tab=despesas' },
      { title: 'Receitas',               path: '/financeiro?tab=receitas' },
      { title: 'Extrato',                path: '/financeiro?tab=extrato' },
      { title: 'Fornecedores e Clientes', path: '#' },
      { title: 'Domus IA',              path: '/financeiro/ia' },
      { title: 'Nota Fiscal',            path: '#' },
    ],
  },
  // hidden: true — exibir quando estiver pronto
  {
    hidden: true,
    title: 'My Account',
    icon: Settings,
    children: [
      {
        ...
        children: [
          ...
          { title: 'Settings - With Sidebar', path: '#' },
          { title: 'Settings - Enterprise', path: '#' },
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Allowed IP Addresses', path: '#' },
