...
/** Menu lateral Metronic — definido em `app-sidebar-menu.config.tsx`. */
export { MENU_SIDEBAR } from '@/config/app-sidebar-menu.config';

export const MENU_MEGA: MenuConfig = [
  { title: 'Dashboard', path: '/layout-1' },
  {
    title: 'Usuários',
    children: [
      {
