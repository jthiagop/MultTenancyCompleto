...
// Class definition
var KTModalAddPermission = function () {
    var submitButton;
    var cancelButton;
    var validator;
    var form;
                    ...
                    if (status == 'Valid') {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                Swal.fire({
                                    text: response.message || "Permissão criada com sucesso!",
                                    icon: "success",
                            ...
                            error: function (xhr) {
                                ...
                                // Show error message
                                var errorMessage = "Erro ao criar a permissão!";
