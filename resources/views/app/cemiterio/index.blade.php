...
<x-tenant-app-layout pageTitle="Modulo Cemitério" :breadcrumbs="[['label' => 'Cemitério']]">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid py-3 py-lg-6">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <a class="btn btn-sm btn-primary me-3 {{ $activeTab === 'cadastro' ? 'active' : '' }}"
                                        href="{{ route('cemiterio.index', ['tab' => 'cadastro']) }}"> <i
                                            class="fas fa-cross"></i> Adicionar Falecido
                                    </a>
                                    <!--begin::Menu-->
                                    <div class="me-0">
            ...
            <!--end::Navbar-->
            @includeIf("app.cemiterio.tabs.{$activeTab}")
