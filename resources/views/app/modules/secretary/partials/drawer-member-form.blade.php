{{-- Drawer para cadastro/edição de membro religioso --}}
<x-tenant-drawer drawerId="kt_drawer_member" title="Cadastro de Novo Membro" width="100%"
    toggleButtonId="kt_drawer_member_button" closeButtonId="kt_drawer_member_close">
                            ...
                            <div id="kt_schedule_day_4" class="tab-pane fade show">
                                ...
                                <div class="d-flex flex-stack position-relative mt-6">
                                    ...
                                    <div class="fw-semibold ms-5">
                                        ...
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="fs-5 fw-bold text-dark text-hover-primary mb-2">Marketing Campaign
                                            Discussion</a>
                                        <!--end::Title-->
                                        <!--begin::User-->
                                        <div class="fs-7 text-muted">Lead by
                ...
                <div class="card card-flush mb-6 mb-xl-9">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center position-relative mb-7">
                            ...
                            <!--begin::Details-->
                            <div class="fw-semibold ms-5">
                                <a href="#" class="fs-5 fw-bold text-dark text-hover-primary">Schedule a meeting
                        ...
                        <div class="d-flex align-items-center position-relative mb-7">
                            ...
                            <!--begin::Details-->
                            <div class="fw-semibold ms-5">
                                <a href="#" class="fs-5 fw-bold text-dark text-hover-primary">Dashboard UI & UX
                                    for Leafr CRM</a>
                                <!--begin::Info-->
                                <div class="fs-7 text-muted">Due in 1 week
                        ...
                        <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!--end::Event=-->
                                    <!--begin::Timestamp=-->
                                    <td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2023, 5:20 pm</td>
                                    <!--end::Timestamp=-->
                                </tr>
                                <!--end::Table row-->
                                <!--begin::Table row-->
                                ...
                                <tr>
                                    ...
                                    <!--end::Event=-->
                                    <!--begin::Timestamp=-->
                                    <td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2023, 6:05 pm</td>
                                    <!--end::Timestamp=-->
                                </tr>
                                <!--end::Table row-->
                                <!--begin::Table row-->
                                <tr>
                                    ...
                                    <!--end::Event=-->
                                    <!--begin::Timestamp=-->
                                    <td class="pe-0 text-gray-600 text-end min-w-200px">25 Jul 2023, 11:05 am</td>
                                    <!--end::Timestamp=-->
                                </tr>
                                <!--end::Table row-->
                            </tbody>
    ...
    <x-slot:footer>
        <div class="d-flex justify-content-end gap-3">
            <button type="button" class="btn btn-light" id="kt_drawer_member_close">
                Cancelar
            </button>
            <button type="submit" form="form-member" class="btn btn-primary" id="btn_submit_member">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const roleSelect = document.getElementById('member_role_slug');
            const ordenacaoFields = document.getElementById('ordenacao_fields');

            // Mostrar/ocultar campos de ordenação baseado na função
            if (roleSelect) {
                roleSelect.addEventListener('change', function() {
                    const showOrdenacao = ['presbitero', 'diacono'].includes(this.value);
                    ordenacaoFields.style.display = showOrdenacao ? 'flex' : 'none';
                });
            }
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    const submitBtn = document.getElementById('btn_submit_member');
                    const memberId = document.getElementById('member_id').value;
                    const url = memberId ?
                        `{{ route('secretary.index') }}/${memberId}` :
                        '{{ route('secretary.store') }}';
                    ...
                    fetch(url, {
                        ...
                        .then(data => {
                            if (data.success) {
                                // Fechar drawer
                                const drawerEl = document.getElementById('kt_drawer_member');
                                ...
                                if (typeof Swal !== 'undefined') {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Sucesso!',
                                        text: data.message || 'Membro salvo com sucesso!',
                                        timer: 2000,
                                ...
                                const tableId = '{{ $tableId ?? 'kt_secretary_table' }}';
                                ...
                                if (typeof Swal !== 'undefined') {
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Erro!',
                                        text: data.message || 'Erro ao salvar membro.',
                                    });
                                }
                            }
                        })
        ...
        // Função para abrir drawer em modo edição
        function editMember(id) {
            fetch(`{{ route('secretary.index') }}/${id}/edit`, {
                    headers: {
                        'Accept': 'application/json',
                        'X-Requested-With': 'XMLHttpRequest'
                    }
                ...
                .then(data => {
                    if (data.success && data.member) {
                        ...
                        document.getElementById('member_nome').value = member.nome || '';
                        document.getElementById('member_nome_religioso').value = member.nome_religioso || '';
                        document.getElementById('member_email').value = member.email || '';
                        document.getElementById('member_telefone').value = member.telefone || '';
                        document.getElementById('member_data_nascimento').value = member.data_nascimento || '';
                        document.getElementById('member_naturalidade').value = member.naturalidade || '';
                        document.getElementById('member_role_slug').value = member.role_slug || '';
                        document.getElementById('member_provincia_id').value = member.provincia_id || '';
                        document.getElementById('member_profession').value = member.profession || '';
                        document.getElementById('member_data_profissao').value = member.data_profissao || '';
                        document.getElementById('member_data_ordenacao').value = member.data_ordenacao || '';
                        document.getElementById('member_local_ordenacao').value = member.local_ordenacao || '';
                        document.getElementById('member_observacoes').value = member.observacoes || '';

                        // Trigger change no role para mostrar/ocultar campos de ordenação
                        document.getElementById('member_role_slug').dispatchEvent(new Event('change'));

                        // Atualizar título do drawer
                        const drawerTitle = document.querySelector('#kt_drawer_member .drawer-title');
                        if (drawerTitle) drawerTitle.textContent = 'Editar Membro';
        ...
        // Função para resetar drawer para modo criação
        function resetMemberDrawer() {
            const form = document.getElementById('form-member');
            if (form) form.reset();

            document.getElementById('member_id').value = '';
            document.getElementById('ordenacao_fields').style.display = 'none';

            const drawerTitle = document.querySelector('#kt_drawer_member .drawer-title');
            if (drawerTitle) drawerTitle.textContent = 'Cadastro de Novo Membro';
        }

        // Reset ao fechar drawer
        document.addEventListener('DOMContentLoaded', function() {
            const drawerEl = document.getElementById('kt_drawer_member');
            if (drawerEl) {
                drawerEl.addEventListener('kt.drawer.hide', function() {
                    resetMemberDrawer();
                });
            }
        });
