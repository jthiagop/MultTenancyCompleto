                            ...
                            <div class="card card-flush h-lg-100">
                                    ...
                                    <div class="card-header mt-5">
                                        ...
                                        <div class="card-title flex-column">
                                            <h3 class="fw-bold mb-1">Foros Cadastrados</h3>
                                        ...
                                        <div class="card-toolbar my-1">
                                            ...
                                            <!--end::Select-->
                                            <!--begin::Search-->
                                            <div class="d-flex align-items-center position-relative me-4 my-1">
                                            ...
                                            <div class="me-6 my-1">
                                                <!--begin::Link-->
                                                <a class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_new_address">[+] Add Foro</a>
                                            </div>
                                        </div>
                                        <!--begin::Card toolbar-->
                                    </div>
                                    ...
                                    <thead class="fs-7 text-gray-400 text-uppercase">
                                        <tr>
                                            ...
                                            <th class="min-w-250px">Nome foro</th>
                                            <th class="min-w-90px">cidade</th>
                                            <th class="min-w-250px">Rua</th>
                                            <th class="min-w-150px">Bairro</th>
                                            <th class="min-w-150px">cód. município</th>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <a href=""
                                                            class="fs-6 text-gray-800 text-hover-primary">{{ $nameForo->name }}</a>
                                                        <div class="fw-semibold text-gray-400">{{ $nameForo->numForo }}</div>
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                                <!--end::User-->
                                            </td>
                                            <td>{{ $nameForo->localidade }}</td>
                                            <td>{{ $nameForo->logradouro }}</td>
                                            <td>{{ $nameForo->bairro }}</td>
                                            <td>{{ $nameForo->ibge }}</td>
                                            <td>
                                                <span
                                                class="badge badge-light-success fw-bold px-4 py-3">{{ $nameForo->localidade }}</span>
                                            </td>
                                            <!--begin::Action=-->
<td class="text-end">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
        ...
        <div class="menu-item px-3">
            <a href="#"
                onclick="openEditAddressModal({{ $nameForo->toJson() }})"
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="kt_profile_overview_table"
                                    ...
                                    <thead class="fs-7 text-gray-400 text-uppercase">
                                        <tr>
                                            <th class="min-w-50px">N°</th>
                                            <th class="min-w-150px">Nome foro</th>
                                            <th class="min-w-90px">cidade</th>
                                            <th class="min-w-150px">Rua</th>
                                            <th class="min-w-50px">Bairro</th>
                                            <th class="min-w-50px">código do município</th>
                                            <th class="min-w-90px">Status</th>
                        ...
                        <div class="py-5">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="/tenancy/assets/media/avatars/300-23.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="/tenancy/assets/media/avatars/300-13.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="/tenancy/assets/media/avatars/300-21.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="/tenancy/assets/media/illustrations/sketchy-1/1.png" alt=""
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="#">
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                <label class="fs-6 fw-semibold mb-2">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                        title="A que patrimônio pertence esse imovel"></i>
                                </label>
                                <select class="form-select form-select-solid" data-control="select2"
                                    data-hide-search="true" data-placeholder="Pertence a que patrimônio?"
                                    name="target_assign">
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control form-control-solid" id="kt_docs_maxlength_always_show" maxlength="250"
                                rows="3" name="target_details" placeholder="Type Target Details"></textarea>
    ...
    <!--end::Modals-->
		...
		<div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content">
					<!--begin::Form-->
                    <form id="kt_modal_new_address_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('namePatrimonio.store') }}">
                        @csrf
							...
							<div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="row mb-5">
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        <!--begin::Label-->
                                        <label class="required fs-5 fw-semibold mb-2">Nome do Foro</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
								...
								<div class="row mb-5">
									...
									<div class="col-md-6 fv-row">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" class="form-control form-control-solid" placeholder="" id="bairro" name="bairro" />
										<!--end::Input-->
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-md-6 fv-row">
										...
										<!--end::Label-->
										<!--end::Input-->
										<input type="text" class="form-control form-control-solid" placeholder="" id="localidade" name="localidade" />
										<!--end::Input-->
									</div>
									<!--end::Col-->
								</div>
                                ...
                                <div class="row mb-5">
									...
									<!--end::Label-->
									<!--begin::Select-->
									<select id="uf" name="uf" data-control="select2" data-dropdown-parent="#kt_modal_new_address" data-placeholder="Select a Country..." class="form-select form-select-solid">
                                ...
                                <div class="col-md-4 fv-row">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-solid" placeholder="" id="ibge" name="ibge" />
									<!--end::Input-->
								    <!--end::Input group-->
                                </div>
                                <div class="col-md-3 fv-row">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-solid" placeholder="" id="numForo" name="numForo" />
									<!--end::Input-->
								    <!--end::Input group-->
                                </div>
                                </div>
...
<script>
    function openAddAddressModal() {
        document.getElementById('kt_modal_new_address_header').querySelector('h2').innerText = 'Adicionar Novo Endereço';
        document.getElementById('method_field').value = 'POST';
        document.getElementById('address_id').value = '';
        document.getElementById('kt_modal_new_address_form').reset();
        document.getElementById('kt_modal_new_address_form').action = "{{ route('namePatrimonio.store') }}";
        $('#kt_modal_new_address').modal('show');
    }

    function openEditAddressModal(address) {
        document.getElementById('kt_modal_new_address_header').querySelector('h2').innerText = 'Atualizar Endereço';
        document.getElementById('method_field').value = 'PUT';
        document.getElementById('address_id').value = address.id;
        document.getElementById('kt_modal_new_address_form').action = "{{ route('namePatrimonio.update', ':id') }}".replace(':id', address.id);
...
<script src="/tenancy/assets/js/custom/apps/patrimonio/patrimonio.js"></script>
<script src="/tenancy/assets/js/widgets.bundle.js"></script>
<script src="/tenancy/assets/js/custom/apps/chat/chat.js"></script>
<script src="/tenancy/assets/js/custom/utilities/modals/new-address-foro.js"></script>
