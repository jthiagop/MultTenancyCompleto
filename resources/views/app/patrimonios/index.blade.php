                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="text-center mb-13 position-relative">
                        ...
                        <span class="d-block mb-4">
                            <img src="/tenancy/assets/media/png/search.png" alt="Ícone de Pesquisa" class="img-fluid" style="width: 80px; max-width: 100px;">
                        </span>
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="/tenancy/assets/media/illustrations/sketchy-1/seo-1-33.svg" alt=""
    ...
    <div class="modal fade" id="kt_modal_new_foro" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <!--begin::Modal header-->
                <!--begin::Modal body-->
                @include('app.components.modals.lancar-patrimonio')
...
<script src="/tenancy/assets/js/custom/utilities/modals/patrimonio/avaliador/avaliador.js"></script>
...
<script src="/tenancy/assets/js/custom/utilities/modals/new-foro.js"></script>
...
<script>
    $(document).ready(function() {
        ...
        $('#patrimonio').select2({
            ...
            dropdownParent: $('#kt_modal_foro_form')
        });

        // Inicializa o InputMask para os campos de telefone
        $('#outorgante_telefone, #outorgado_telefone').inputmask({
            "mask": "(99) 99999-9999"
        });
