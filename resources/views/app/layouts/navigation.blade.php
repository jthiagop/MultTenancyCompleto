        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    {{-- Aqui foi removido os arquivos do menu superiro --}}
    ...
    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="#">
                                    ...
                                    <span class="menu-title">Controle de Veícular</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link {{ Route::currentRouteName() == 'caixa.index' ? 'active' : '' }}"
                                    ...
                                    <span class="menu-title">Modulo de Lançamento</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link"
                                            ...
                                            <span class="menu-title">Cadastro de Banco</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
        ...
        <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
            <a href="#"
                ...
                <span class="btn-label">Documentos e Componentes</span>
                <!--begin::Svg Icon | path: icons/duotune/general/gen005.svg-->
