{{-- 
    Partial: Lista de Conciliações (reutilizável nas 3 tabs)
    Recebe: conciliacoesPendentes, entidade, centrosAtivos, lps, formasPagamento, activeTab
--}}
...
<div class="card-body">
    ...
    @else
        ...
        <!-- Botões de paginação -->
        {{ $conciliacoesPendentes->appends(['tab' => $activeTab])->links('pagination::bootstrap-5') }}
    @endif
</div>
