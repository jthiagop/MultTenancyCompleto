                            ...
                            <div class="card card-flush h-xl-100">
                                ...
                                <div class="card card-flush  flex-row-fluid overflow-hidden h-xl-100 ">
                                    ...
                                    <ul class="nav nav-tabs" id="lancamentoTab{{ $conciliacao->id }}"
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active"
                                                id="novo-lancamento-{{ $conciliacao->id }}-tab" data-bs-toggle="tab"
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="transferencia-{{ $conciliacao->id }}-tab"
                                                data-bs-toggle="tab"
                                    ...
                                    <div class="card card-flush py-4 flex-row-fluid overflow-hidden tab-content p-5 border"
                                                        ...
                                                        fields: [{
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                options: [{
                                                                        value: 'Pix',
                                                                        text: 'Pix',
                                                                        selected: {{ old('tipo_documento') == 'Pix' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'OUTR - Dafe',
                                                                        text: 'OUTR - Dafe',
                                                                        selected: {{ old('tipo_documento') == 'OUTR - Dafe' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'NF - Nota Fiscal',
                                                                        text: 'NF - Nota Fiscal',
                                                                        selected: {{ old('tipo_documento') == 'NF - Nota Fiscal' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'CF - Cupom Fiscal',
                                                                        text: 'CF - Cupom Fiscal',
                                                                        selected: {{ old('tipo_documento') == 'CF - Cupom Fiscal' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'DANF - Danfe',
                                                                        text: 'DANF - Danfe',
                                                                        selected: {{ old('tipo_documento') == 'DANF - Danfe' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'BOL - Boleto',
                                                                        text: 'BOL - Boleto',
                                                                        selected: {{ old('tipo_documento') == 'BOL - Boleto' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'REP - Repasse',
                                                                        text: 'REP - Repasse',
                                                                        selected: {{ old('tipo_documento') == 'REP - Repasse' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'CCRD - Cartão de Credito',
                                                                        text: 'CCRD - Cartão de Credito',
                                                                        selected: {{ old('tipo_documento') == 'CCRD - Cartão de Credito' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'CDBT - Cartão de Debito',
                                                                        text: 'CDBT - Cartão de Debito',
                                                                        selected: {{ old('tipo_documento') == 'CDBT - Cartão de Debito' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'CH - Cheque',
                                                                        text: 'CH - Cheque',
                                                                        selected: {{ old('tipo_documento') == 'CH - Cheque' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'REC - Recibo',
                                                                        text: 'REC - Recibo',
                                                                        selected: {{ old('tipo_documento') == 'REC - Recibo' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'CARN - Carnê',
                                                                        text: 'CARN - Carnê',
                                                                        selected: {{ old('tipo_documento') == 'CARN - Carnê' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'FAT - Fatura',
                                                                        text: 'FAT - Fatura',
                                                                        selected: {{ old('tipo_documento') == 'FAT - Fatura' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'APOL - Apólice',
                                                                        text: 'APOL - Apólice',
                                                                        selected: {{ old('tipo_documento') == 'APOL - Apólice' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'DUPL - Duplicata',
                                                                        text: 'DUPL - Duplicata',
                                                                        selected: {{ old('tipo_documento') == 'DUPL - Duplicata' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'TRIB - Tribunal',
                                                                        text: 'TRIB - Tribunal',
                                                                        selected: {{ old('tipo_documento') == 'TRIB - Tribunal' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'Outros',
                                                                        text: 'Outros',
                                                                        selected: {{ old('tipo_documento') == 'Outros' ? 'true' : 'false' }}
                                                                    },
                                                                    {
                                                                        value: 'T Banc - Transferência Bancaria',
                                                                        text: 'T Banc - Transferência Bancaria',
                                                                        selected: {{ old('tipo_documento') == 'T Banc - Transferência Bancaria' ? 'true' : 'false' }}
                                                                    }
                                                                ]
                                                            },
                                                            {
                                                        ...
                                                        if (checkbox && anexoInputContainer) {
                                                            checkbox.addEventListener('change', function() {
                                                                if (this.checked) {
                                                                    ...
                                                                    setTimeout(() => {
                                                                        const anexosContainer = anexoInputContainer.querySelector(
                                                                            '.anexos-container[data-name="anexos"][data-unique-id="{{ $conciliacao->id }}"]'
                                                                        );
                                                                        if (anexosContainer) {
                                                                            ...
                                                                            if (anexosContainer.dataset.initialized === 'true') {
                                                                                anexosContainer.querySelectorAll(
                                                                                    'select[data-control="select2"]').forEach(
                                                                                    select => {
                                                                                        const isInitialized = select.classList
                                                                                            .contains(
                                                                                                'select2-hidden-accessible') ||
                                                                                            (typeof KTSelect2 !== 'undefined' &&
                                                                                                KTSelect2.getInstance(select));
                                                                                        if (!isInitialized) {
                                                                                            if (typeof KTSelect2 !==
                                                                                                'undefined') {
                                                                                ...
                                                                                const functionName =
                                                                                    'initAnexosComponent_anexos_{{ $conciliacao->id }}';
                                        ...
                                        <!-- Aba Transferência -->
                                        <div class="tab-pane fade" id="transferencia-{{ $conciliacao->id }}-pane"
                                            role="tabpanel"
                                            ...
                                            <form id="form-transferencia-{{ $conciliacao->id }}"
                                                ...
                                                @csrf
                                                <!-- Container onde o formulário será renderizado via JSON -->
                                                <div id="form-transferencia-container-{{ $conciliacao->id }}">
                                                </div>
                                            </form>
                                            ...
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    ...
                                                    setTimeout(() => {
                                                        const lancamentoSelect = document.getElementById('lancamento_padrao_id_transferencia_' +
                                                            conciliacaoId);
                                                        if (lancamentoSelect && lancamentoSelect.parentElement) {
                                                            const helpText = document.createElement('div');
                                                            helpText.className = 'form-text';
                                                            helpText.textContent =
                                                                'Selecione um lançamento padrão do tipo "Ambos" ou relacionado a transferências';
                                                            ...
                                                            success: function(response) {
                                                                ...
                                                                if (response.success && response.contas && response.contas.length > 0) {
                                                                    ...
                                                                    response.contas.forEach(function(conta) {
                                                                        const optionText = conta.nome + (conta.account_type_label ?
                                                                            ' - ' + conta.account_type_label : '');
                                                                    ...
                                                                    console.warn('Nenhuma conta encontrada. Total:', response.total ||
                                                                        0); // Debug
                                                                }
                                                            },
                                                            error: function(xhr) {
    ...
    function renderFormFromJSON(formConfig, containerId) {
        ...
        if (formConfig.hiddenFields) {
            formConfig.hiddenFields.forEach(field => {
                ...
                html +=
                    `<input type="hidden" name="${field.name}" value="${escapedValue}" ${field.class ? `class="${field.class}"` : ''}>`;
            });
        }
            ...
            formConfig.fields.forEach(field => {
                if (field.loadViaAjax && field.type === 'select') {
                    ...
                    if (selectElement && field.name === 'entidade_destino_id') {
                        ...
                        const entidadeOrigemId = formConfig.hiddenFields?.find(f => f.name ===
                            'entidade_origem_id')?.value;

                        if (conciliacaoId && entidadeOrigemId) {
                            carregarContasDisponiveisAjax(selectElement, conciliacaoId,
                                entidadeOrigemId);
                        }
                    }
                }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success && response.contas && response.contas.length > 0) {
                    ...
                    response.contas.forEach(function(conta) {
                        const optionText = conta.nome + (conta.account_type_label ? ' - ' + conta
                            .account_type_label : '');
                        const option = $('<option></option>')
                            .attr('value', conta.id)
                            .text(optionText);
            ...
            case 'select':
                ...
                if (field.options) {
                    field.options.forEach(option => {
                        ...
                        html +=
                            `<option value="${optionValue}" ${selected} ${option.dataType ? `data-type="${option.dataType}"` : ''}>${optionText}</option>`;
                    });
                }
                html += '</select>';
