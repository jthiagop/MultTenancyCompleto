@php
    $key = 'inativos';
    $tableId = 'kt_parceiros_inativos_table';
    
    $tableColumns = [
        ['key' => 'nome', 'label' => 'Nome / Razão Social', 'width' => 'min-w-200px'],
        ['key' => 'tipo', 'label' => 'Tipo', 'width' => 'min-w-100px'],
        ['key' => 'documento', 'label' => 'CNPJ / CPF', 'width' => 'min-w-130px'],
            ...
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" class="form-control form-control-solid w-250px ps-12 parceiro-search"
                           data-table="{{ $tableId }}"
                           placeholder="Buscar parceiro inativo..." />
                </div>
            </div>
