            ...
            <div class="card-header hover-scroll-x overflow-x-auto">
                ...
                <!--end::Nav-->
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <button class="btn btn-sm btn-primary" data-kt-menu-trigger="click"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">
                                        O que deseja criar?</div>
                                </div>
                                <!--end::Heading-->

                                <!--begin::Menu Item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" onclick="abrirDrawerLancamento('receita', 'Banco'); return false;"
                                        aria-label="Adicionar nova receita">
                                        <span class="me-2"><i class="fa-regular fa-circle-up text-success"></i></span>
                                        Nova Receita
                                    </a>
                                </div>
                                <!--end::Menu Item-->
                                <!--begin::Menu Item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" onclick="abrirDrawerLancamento('despesa', 'Banco'); return false;"
                                        aria-label="Adicionar nova despesa">
                                        <span class="me-2"><i class="fa-regular fa-circle-down text-danger"></i></span>
                                        Nova Despesa
                                    </a>
                                </div>
                                <!--end::Menu Item-->
                        ...
                        <x-tenant-button-icon icon="bi bi-link-45deg" text="Conciliação Bancária" dataBsToggle="modal"
                            dataBsTarget="#modalConciliacao" variant="primary" size="sm" />
                        ...
                        <div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('bank-statements.index') }}" class="menu-link px-3">Extrato</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('domusia.index') }}" class="menu-link flex-stack px-3">Domus IA
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('company.edit', ['tab' => 'horario-missas']) }}" class="menu-link px-3">Horário de Missa</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3" data-kt-menu-trigger="hover"
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3 ">
                                            <a class="menu-link px-3 {{ Route::currentRouteName() == 'entidades.index' ? 'active' : '' }}"href="{{ route('entidades.index') }}">                                                Criar Entidade Financeira</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a class="menu-link px-3 {{ Route::currentRouteName() == 'lancamentoPadrao.index' ? 'active' : '' }}"
                                            href="{{ route('lancamentoPadrao.index') }}">Categorias Financeiras</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3 ">
                                            <a class="menu-link px-3 {{ Route::currentRouteName() == 'costCenter.index' ? 'active' : '' }}"href="{{ route('costCenter.index') }}">Centro de Custos</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3 ">
                                            <a class="menu-link px-3 {{ Route::currentRouteName() == 'formas-pagamento.index' ? 'active' : '' }}"href="{{ route('formas-pagamento.index') }}">Formas de Pagamento</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3 ">
                                            <a class="menu-link px-3 {{ Route::currentRouteName() == 'entidades.index' ? 'active' : '' }}" href="{{ route('entidades.index') }}">Entidades Financeiras</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu sub-->
