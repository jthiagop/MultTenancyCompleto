@php
    ...
    // Stats padrão para Contas a Pagar
    $stats = [
        ...
        ['key' => 'pagos', 'label' => 'Pagos (R$)', 'value' => '0,00', 'variant' => 'success'],
    ...
    $tableColumns = [
        ...
        ['key' => 'a_pagar', 'label' => 'A pagar (R$)', 'width' => 'min-w-70px', 'orderable' => true],
    ...
    <x-tenant.segmented-tabs-toolbar 
        ...
        <x-slot:tableContent>
            ...
            <div id="table-wrapper-{{ $tableIdFinal }}" class="d-none">
                <!--begin::Table-->
                <table class="table align-middle table-striped table-row-dashed fs-6 gy-4 mt-7"
                    id="{{ $tableIdFinal }}">
                    <thead>
