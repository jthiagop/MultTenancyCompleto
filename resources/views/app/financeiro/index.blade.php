                            ...
                            <div class="col-lg-6 hover-elevate-up parent-hover">
                                ...
                                <a href="{{ route('caixa.create') }}"
                                    ...
                                    <span class="d-block fw-semibold text-start">
                                        ...
                                        <span class="text-muted fw-semibold fs-6">registre todas as transações em
                                            espécie</span>
                                    </span>
                                    <!--end::Info-->
                                </a>
                                ...
                                <a href="{{ route('banco.create') }}"
                                    ...
                                    <span class="svg-icon svg-icon-3x me-5">
                                        <svg version="1.1" id="_x34_" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                stroke-linejoin="round" stroke="#CCCCCC" stroke-width="1.024"></g>
                                            <g id="SVGRepo_iconCarrier">
                                                <g>
                                    ...
                                    <span class="d-block fw-semibold text-start">
                                        ...
                                        <span class="text-muted fw-semibold fs-6">transações financeiras que ocorrem
                                            por meio de contas bancárias.</span>
                                    </span>
                                    <!--end::Info-->
                                </a>
                                <!--end::Option-->
