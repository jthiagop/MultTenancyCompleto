											...
											<div class="card card-flush overflow-hidden h-md-100">
												...
												<div class="card-header py-5">
													...
													<h3 class="card-title align-items-start flex-column">
														...
														<span class="text-gray-400 mt-1 fw-semibold fs-6">Despesas por tipo de transação</span>
													</h3>
													<!--end::Title-->
													<!--begin::Toolbar-->
												...
												<div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
													...
													<div class="px-9 mb-5">
														...
														<div class="d-flex align-items-center mb-2">
															...
															<!--end::Currency-->
															<!--begin::Value-->
															<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{{ number_format($valorSaidas, 2, ',', '.') }}</span>
															<!--end::Value-->
															<!--begin::Label-->
												...
												<div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
													...
													<div class="px-9 mb-5">
														...
														<div class="d-flex mb-2">
															<span class="fs-4 fw-semibold text-gray-400 me-1">R$</span>
															<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{{ number_format($valorEntrada, 2, ',', '.') }}</span>
														</div>
														<!--end::Statistics-->
														<!--begin::Description-->
														<span class="fs-6 fw-semibold text-gray-400">Total de receita no mês</span>
														<!--end::Description-->
													</div>
													<!--end::Statistics-->
													<!--begin::Chart-->
