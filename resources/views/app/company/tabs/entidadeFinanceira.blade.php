                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-8 fv-row d-none" id="banco-group">
                            ...
                            <select id="banco-select" name="banco" class="form-select form-select-solid"
                                ...
                                <!-- Exemplo manual: -->
                                <option value="Banco Bradesco" data-icon="/assets/media/svg/bancos/bradesco.svg">Banco
                                    Bradesco</option>
                                <option value="Banco Caixa" data-icon="/assets/media/svg/bancos/caixa.svg">Banco Caixa
                                </option>
                                <option value="Banco Nubank" data-icon="/assets/media/svg/bancos/nubank.svg">Banco
                                    Nubank
                                </option>
                                <option value="Banco Itau" data-icon="/assets/media/svg/bancos/itau.svg">Banco Itaú
                                </option>
                                <option value="Banco do Brasil" data-icon="/assets/media/svg/bancos/brasil.svg">Brasil
                                    do
                                    Brasil</option>
                                <option value="Banco stone" data-icon="/assets/media/svg/bancos/stone.svg">Banco Stone
                                </option>
                                <option value="Banco Unicred" data-icon="/assets/media/svg/bancos/unicred.svg">Banco
                                    Unicred
                                </option>
                                <option value="Banco Inter" data-icon="/assets/media/svg/bancos/inter.svg">Banco Inter
                                </option>
                                <!-- ... e assim por diante -->
                            </select>
