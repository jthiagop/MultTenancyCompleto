...
<x-tenant-app-layout pageTitle="Cadastro de Forma de Recebimento" :breadcrumbs="[['label' => 'Financeiro', 'url' => route('banco.list')], ['label' => 'Formas de Recebimento']]">
    {{-- *** Modal Add Forma de Recebimento *** --}}
    @include('app.components.modals.company.formaRecebimento')
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card pt-4 mb-6 mb-xl-9">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <button type="button" class="btn btn-sm btn-flex btn-light-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_add_recebimento">
                ...
                <div class="card-body pt-0 pb-5">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed gy-5" id="kt_table_formas_recebimento">
                        <!--begin::Table head-->
...
<script>
    $(document).ready(function() {
        $('#kt_table_formas_recebimento').DataTable({
            language: {
