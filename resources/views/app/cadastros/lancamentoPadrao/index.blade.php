							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Cadastro de Lançamento Padrão</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
													...
													<!--end::Export-->
													<!--begin::Add customer-->
													<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Lançamento Padrão</button>
													<!--end::Add customer-->
												</div>
												<!--end::Toolbar-->
												<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<tbody class="fw-semibold text-gray-600">
                                                    ...
                                                    <tr>
														...
														<!--begin::Name=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">{{ $lp->description }}</a>
														</td>
														<!--end::Name=-->
														<!--begin::Email=-->
														<td>
                                                            <div class=" badge {{ $categoryColors[$lp->category] ?? 'text-muted' }}">
                                                                {{ $lp->category }}
                                                            </div>
                                                        </td>
														<!--end::Email=-->
														...
														<td>
															<!--begin::Badges-->
                                                            <div class="badge {{ $lp->type === 'entrada' ? 'badge-light-success' : 'badge-light-danger' }}">
                                                                {{ $lp->type }}
                                                            </div>
															<!--end::Badges-->
														</td>
