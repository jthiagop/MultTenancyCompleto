<x-tenant-app-layout pageTitle="Cadastro de Lançamento Padrão"
    :breadcrumbs="[['label' => 'Financeiro', 'url' => route('banco.list')], ['label' => 'Categorias Financeiras']]">
                                ...
                                <form class="form" method="POST" action="{{ route('lancamentoPadrao.store') }}"
                                    ...
                                    <button type="submit" class="btn btn-primary" id="kt_careers_submit_button">
                                        <span class="indicator-label">
                                            <i class="bi bi-save me-2"></i> <!-- Ícone de salvar + margem à direita -->
                                            Cadastrar
                                        </span>
                                    </button>
                                    <!--end::Submit-->
