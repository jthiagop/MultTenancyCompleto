                            ...
                            <div class="d-flex flex-column flex-lg-row">
                                    ...
                                    <div class="card mb-5 mb-xl-8">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-center flex-column py-5">
                                                ...
                                                <div class="mb-9">
                                                    <!--begin::Badge-->
                                                    <div class="badge badge-lg badge-light-primary d-inline">Administrator
                                                    </div>
                                                    <!--begin::Badge-->
                                                </div>
                                                <!--end::Position-->
                                                ...
                                                <div class="d-flex flex-stack flex-grow-1">
                                                    ...
                                                    <div class="fw-semibold">
                                                        <div class="fs-6 text-gray-700">Ao criar uma conta, o utilizador aceita
                                                            a nossa <a href="#" class="me-1">política de privacidade</a> e os nossos <a href="#" class="me-1">termos de uso</a>.
                                                ...
                                                <div class="d-flex flex-stack">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="fs-6 fw-semibold text-muted">Planear corretamente o seu fluxo de trabalho</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex flex-stack">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="fs-6 fw-semibold text-muted">Fique de olho nos seus Repositórios</div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-end">
                                                        <!--begin::Switch-->
                                                ...
                                                <div class="d-flex flex-stack">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="fs-6 fw-semibold text-muted">Integrar discussões de projectos</div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-end">
                                                        <!--begin::Switch-->
                                ...
                                <div class="flex-lg-row-fluid ms-lg-15">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                                            ...
                                                            <div class="d-flex flex-stack position-relative mt-6">
                                                                ...
                                                                <div class="fw-semibold ms-5">
                                                                    ...
                                                                    <div class="fs-7 mb-1">10:00 - 11:00
                                                                        <span
                                                                            class="fs-7 text-muted text-uppercase">am</span>
                                                                    </div>
                                                                    <!--end::Time-->
                                                                    <!--begin::Title-->
                                                                    <a href="#"
                                        ...
                                        <!--end:::Tab pane-->
                                        <!--begin:::Tab pane-->
                                        <div class="tab-pane fade" id="kt_user_view_overview_security"
                                            role="tabpanel">
                                            <!--begin::Card-->
                                            ...
                                            <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex flex-stack flex-grow-1">
                                                        <!--begin::Content-->
                                                        <div class="fw-semibold">
                                                            <div class="fs-6 text-gray-700">ATENÇÃo: é necessário um endereço de E-mail
                                                ...
                                                <div class="fv-row mb-7">
                                                    <x-input-label for="name" class="fs-6 fw-semibold form-label mb-2" :value="__('Name')" />
                                                    <x-text-input id="name" name="name" type="text" class="form-control form-control-solid" :value="old('name', $user->name)" required autofocus autocomplete="name" />
                                                    <x-input-error class="mt-2" :messages="$errors->get('name')" />
                                                </div>

                                                <div class="fv-row mb-7">
                                                    <!--end::Input-->
                                                        <x-input-label for="email" class="fs-6 fw-semibold form-label mb-2" :value="__('Email')" />
                                                        <x-text-input id="email" name="email" type="email" class="form-control form-control-solid" :value="old('email', $user->email)" required autocomplete="username" />
                                                ...
                                                <!--begin::Actions-->
                                                    <div class="flex items-center gap-4">
                                                        <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Sair</button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            ...
                                            <form id="kt_modal_update_password_form" class="form" action="#">
                                                <!--begin::Input group=-->
                                                <div class="fv-row mb-10">
                                                        <x-input-label class="required form-label fs-6 mb-2" for="update_password_current_password" :value="__('Senha Atual')" />
                                                        <x-text-input class="form-control form-control-lg form-control-solid" id="update_password_current_password" name="current_password" type="password" autocomplete="current-password" />
                                                ...
                                                <div class="mb-10 fv-row" data-kt-password-meter="true">
                                                    ...
                                                    <div class="mb-1">
                                                        <!--begin::Label-->
                                                        <x-input-label class="form-label fw-semibold fs-6 mb-2" for="update_password_password" :value="__('Nova Senha')" />
                                                        <!--end::Label-->
                                                        <!--begin::Input wrapper-->
                                                ...
                                                <!--begin::Input group=-->
                                                <div class="fv-row mb-10">
                                                    <x-input-label class="required form-label fs-6 mb-2" for="update_password_password_confirmation" :value="__('Confirme a Senha')" />
