        ...
        <div class="modal fade" id="dm_modal_novo_lancamento_banco" data-bs-backdrop="static" data-bs-keyboard="true"
                                ...
                                <form method="POST" id="dm_modal_novo_lancamento_banco_form"
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12 money"
                                                    ...
                                                    aria-describedby="basic-addon1" id="valor2" name="valor"
                                        ...
                                        <div class="d-flex flex-column mb-5 fv-row">
                                            <ul class="nav nav-tabs nav-line-tabs mb-5 fs-6">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab"
                                                        href="#kt_tab_pane_5">Histórico complementar</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab"
                                                        href="#kt_tab_pane_3">Anexos</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade" id="kt_tab_pane_3" role="tabpanel">
                                                    <input type="file" name="files[]" id="photos2" />
                                                    <script>
                                                        $("#photos2").kendoUpload({
                                                            async: {
                                    ...
                                    <div class="d-flex flex-center flex-row-fluid pt-6 ">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            id="dm_modal_novo_lancamento_banco_submit">
