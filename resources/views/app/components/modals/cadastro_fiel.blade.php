        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header pb-0 border-0 position-relative">
                ...
                <div class="text-center w-100">
                    ...
                    <div class="text-gray-400 fw-semibold fs-5">Preencha as informações abaixo para cadastrar um novo fiel.
                    </div>
                </div>
                <!--end::Heading-->
                <!--begin::Close-->
                ...
                <form id="kt_modal_new_ticket_form" class="form" action="{{ route('fieis.store') }}" method="POST"
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <input class="form-control form-control-solid ps-12" placeholder="Data nascimento"
                                    name="data_nascimento" id="data_nascimento_input" />
                                <!--end::Datepicker-->
                            </div>
                            <!--end::Input-->
                            <div class="fv-plugins-message-container">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-8 fv-row">
                            ...
                            <div class="row mb-7">
                                <div class="col-md-6">
                                    <label class="fw-semibold required fs-6 mb-2">CPF</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="rg" id="rg"
                                        class="form-control form-control-solid" placeholder="Digite o RG" />
                                    <div class="fv-plugins-message-container">
                                        <div class="fv-help-block">
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            <div class="fv-row mb-7">
                                ...
                                <!--begin::Select2-->
                                <select name="profissao" id="profissao" class="form-select form-select-solid"
                                    data-control="select2" data-placeholder="Selecione uma profissão..."
                                    data-allow-clear="true" data-minimum-results-for-search="0">
                                    <option value="">Selecione uma profissão...</option>
                                    @if (isset($profissoes) && $profissoes->count() > 0)
                                        @foreach ($profissoes as $profissao)
                                            <option value="{{ $profissao->nome }}"
                                                {{ old('profissao') == $profissao->nome ? 'selected' : '' }}>
                                                {{ $profissao->nome }}
                                            </option>
                                        @endforeach
                                    @endif
                                    ...
                                    <div class="fv-plugins-message-container">
                                        <div class="fv-help-block">
                                            <span role="alert" class="invalid-feedback"
                                                id="telefone_secundario-error"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-8">
                        <div class="d-flex flex-stack w-lg-50">
                            <!--begin::Label-->
                            <div class="me-5">
                                <label class="fs-6 fw-semibold form-label">É
                                    Dizimista?</label>
                                <div class="fs-7 fw-semibold text-muted">Marque se este
                                    fiel é um dizimista ativo</div>
                            </div>
                            <!--end::Label-->
                            <!--begin::Switch-->
                            <label class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" name="dizimista" value="1"
                                    id="dizimista_switch" />
                    ...
                    <div class="text-center">
                        ...
                        <div class="btn-group dropup">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" id="kt_modal_new_ticket_clone">Salvar e
                                    Clonar</a>
                                <a class="dropdown-item" href="#" id="kt_modal_new_ticket_novo">Salvar e
                                    Limpar</a>
                            </div>
                        </div>
                    </div>
