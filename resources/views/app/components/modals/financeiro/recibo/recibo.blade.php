                   ...
                   <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                       ...
                       <div class="mb-13 text-center">
                        ...
                        <div class="text-gray-400 fw-semibold fs-5">
                            Preencha os dados abaixo para emitir o recibo referente a estasssssss transação. Após a emissão, você poderá imprimir ou excluir o recibo conforme necessário.
                        </div>       <!--end::Description-->
                       </div>
                       <!--end::Heading-->
                       <!--begin:Form-->
