                                <script>
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        // Controla a exibição do checkbox "Pago" e dos accordions baseado no parcelamento
                                        ...
                                        function setupRecurringDateLogic() {
                                            ...
                                            diaCobrancaSelect.on('change', function() {
                                                ...
                                                vencimentoInput._flatpickr.setDate(newDate, true); // true para disparar onChange se necessário, mas nosso onChange evita loop
                                            });
