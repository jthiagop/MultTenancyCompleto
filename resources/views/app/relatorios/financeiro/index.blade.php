<x-tenant-app-layout>
    ...
    <h1>Relatório - Prestação de Contas</h1>

    </form>


    <form action="{{ route('relatorios.prestacao.de.contas.gerar') }}" method="GET" target="_blank">
        @csrf
                        ...
                        <div class="row g-9 mb-8 fv-row">
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <input class="form-control form-control-solid ps-12"
                                        placeholder="Selecione a data" name="data_inicial" id="data_inicial" type="date" />
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                            ...
                            <div class="col-md-2 fv-row">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--begin::Datepicker-->
                                    <input class="form-control form-control-solid ps-12"
                                        placeholder="Selecione a data" type="date" name="data_final" id="data_final" />
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                                    <!-- Exibindo a mensagem de erro -->
    ...
    <div class="d-flex justify-content-end my-7">
        ...
        <button type="submit" id="kt_ecommerce_add_product_submit" class="btn btn-primary">
            <i class="fa fa-save"></i> <span class="indicator-label">Gerar PDF </span>
        </button>
        <!--end::Button-->
    </div>
