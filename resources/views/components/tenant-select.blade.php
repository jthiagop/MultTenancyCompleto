@props([
    ...
    'showSuggestionStar' => false, // Se true, renderiza a estrela de sugestão
    'suggestionTooltip' => '', // Texto do tooltip da estrela
    'suggestedValue' => null, // Valor sugerido pela IA (para comparação no JS)
])
