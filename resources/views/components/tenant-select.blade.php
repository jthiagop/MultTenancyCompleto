    ...
    <div class="input-group" style="position: relative;">
        @if($showSuggestionStar)
            <span class="suggestion-star-wrapper suggestion-star-{{ $id ?? $name }}" 
                  style="position: absolute; right: 28px; top: 50%; transform: translateY(-50%); z-index: 9999; pointer-events: auto; cursor: pointer; width: 20px; height: 20px; display: none; align-items: center; justify-content: center;"
