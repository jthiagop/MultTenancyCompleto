            <div id="kt_app_header" class="app-header">
                ...
                <div class="app-container container-xxl d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="{{ route('central.dashboard') }}" class="d-lg-none">
                            <img alt="Logo" src="/tenancy/assets/media/logos/default-small.svg"
                                class="theme-light-show h-30px" />
                            <img alt="Logo" src="/tenancy/assets/media/logos/default-small-dark.svg"
                                            ...
                                            <div class="tab-content py-4 py-lg-8 px-lg-7">
                                                ...
                                                <div class="tab-pane active w-lg-1000px"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3 mb-6 mb-lg-0">
                                                                    <!--begin:Menu heading-->
                                                                    <h4 class="fs-6 fs-lg-4 fw-semibold mb-3 ms-4">User
                                                                        Profile</h4>
                                                                    <!--end:Menu heading-->
                                                                    <!--begin:Menu item-->
                                                                    <div class="menu-item p-0 m-0">
                                                                ...
                                                                <div class="col-lg-3 mb-6 mb-lg-0">
                                                                    ...
                                                                    <div class="mb-6">
                                                                        <!--begin:Menu heading-->
                                                                        <h4 class="fs-6 fs-lg-4 fw-semibold mb-3 ms-4">
                                                                            Corporate</h4>
                                                                        <!--end:Menu heading-->
                                                                        <!--begin:Menu item-->
                                                                        <div class="menu-item p-0 m-0">
                                                                        ...
                                                                        <div class="menu-item p-0 m-0">
                                                                            <!--begin:Menu link-->
                                                                            <a href="../../demo1/dist/pages/faq.html"
                                                                                class="menu-link">
                                                        ...
                                                        <!--begin:Col-->
                                                        <div class="col-lg-4">
                                                            <img src="/tenancy/assets/media/stock/600x600/img-82.jpg"
                                                ...
                                                <div class="tab-pane w-lg-600px"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!--begin:Col-->
                                                        <div class="col-lg-7">
                                                            <img src="/tenancy/assets/media/stock/900x600/46.jpg"
                                                                class="rounded mw-100" alt="" />
                                                        </div>
                                                        <!--end:Col-->
                                                    </div>
                                                ...
                                                <div class="tab-pane w-lg-600px"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-0">
                                                                <!--begin:Menu heading-->
                                                                <h4 class="fs-6 fs-lg-4 fw-semibold mb-3 ms-4">General
                                                                </h4>
                                                                <!--end:Menu heading-->
                                                                <!--begin:Menu item-->
                                                                <div class="menu-item p-0 m-0">
                                                        ...
                                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-0">
                                                                <!--begin:Menu heading-->
                                                                <h4 class="fs-6 fs-lg-4 fw-semibold mb-3 ms-4">Email
                                                                    Templates</h4>
                                                                <!--end:Menu heading-->
                                                                <!--begin:Menu item-->
                                                                <div class="menu-item p-0 m-0">
                                                ...
                                                <div class="tab-pane w-lg-1000px"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5 pe-lg-5">
                                                            <img src="/tenancy/assets/media/stock/600x600/img-84.jpg"
                                                                class="rounded mw-100" alt="" />
                                                        </div>
                                                        <!--end:Col-->
                                                    </div>
                                        ...
                                        <div class="menu-state-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7 mb-3 pt-2 pe-lg-8">
                                                    <img src="/tenancy/assets/media/stock/900x600/74.jpg"
                                                        class="rounded mw-100" alt="" />
                                                </div>
                                                <!--end:Col-->
                                            </div>
                                ...
                                <div id="kt_header_search" class="header-search d-flex align-items-stretch"
                                    ...
                                    <div data-kt-search-element="content"
                                        ...
                                        <div data-kt-search-element="wrapper">
                                            ...
                                            <div data-kt-search-element="results" class="d-none">
                                                ...
                                                <div class="scroll-y mh-200px mh-lg-350px">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/tenancy/assets/media/avatars/300-2.jpg"
                                                                alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/tenancy/assets/media/avatars/300-9.jpg"
                                                                alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/tenancy/assets/media/avatars/300-14.jpg"
                                                                alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <!--begin::Symbol-->
                                                        <div class="symbol symbol-40px me-4">
                                                            <img src="/tenancy/assets/media/avatars/300-11.jpg"
                                                                alt="" />
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Title-->
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="/tenancy/assets/media/svg/brand-logos/volicity-9.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="/tenancy/assets/media/svg/brand-logos/tvit.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="/tenancy/assets/media/svg/misc/infography.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="/tenancy/assets/media/svg/brand-logos/leaf.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <div class="symbol symbol-40px me-4">
                                                            <span class="symbol-label bg-light">
                                                                <img class="w-20px h-20px"
                                                                    src="/tenancy/assets/media/svg/brand-logos/tower.svg"
                                                                    alt="" />
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                            ...
                                            <div class="mb-5" data-kt-search-element="main">
                                                ...
                                                <div class="d-flex flex-stack fw-semibold mb-4">
                                                    <!--begin::Label-->
                                                    <span class="text-muted fs-6 me-2">Pesquisas Recentes:</span>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Items-->
                                        ...
                                        <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                            <!--begin::Heading-->
                                            <h3 class="fw-semibold text-dark mb-7">Pesquisa Avançada</h3>
                                            <!--end::Heading-->
                                            <!--begin::Input group-->
                                            <div class="mb-5">
                                                <input type="text"
                            ...
                            <div class="app-navbar-item ms-1 ms-lg-3">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                    ...
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                        style="background-image:url('tenancy/assets/media/misc/menu-header-bg.jpg')">
                                        <!--begin::Title-->
                                            ...
                                            <div class="d-flex flex-column px-9">
                                                ...
                                                <div class="text-center px-4">
                                                    <img class="mw-100 mh-200px" alt="image"
                                                        src="/tenancy/assets/media/illustrations/sketchy-1/1.png" />
                                                </div>
                                                <!--end::Illustration-->
                                            </div>
                                            <!--end::Wrapper-->
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                    ...
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">Tela Principal</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <!--end:Menu link-->
                                    <!--begin:Menu sub-->
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="{{ route('tenants.index') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="../../demo1/dist/authentication/general/maintenance.html">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Maintenance</span>
