    ...
    var createCountUp = function () {
        ...
        elements.map(function (element) {
            if (KTUtil.isInViewport(element) && KTUtil.visible(element)) {
                ...
                value = parseFloat(value.replace(/,/g, "")); // Remover vírgulas e converter para número

                // Verificação e configuração de casas decimais
                var decimalPlaces = 2; // Definindo 2 casas decimais por padrão

                if (element.hasAttribute('data-kt-countup-decimal-places')) {
                    decimalPlaces = parseInt(element.getAttribute('data-kt-countup-decimal-places'));
                }
                ...
                options.separator = '.'; // Usar ponto como separador de milhar
                options.decimal = ','; // Usar vírgula como separador decimal
